...
**Type**: service
**Status**: production
**Registry product**: Janua (`janua`, live, front door janua.dev).
...
# Logs
enclii logs janua-api --env prod -f                    # live tail
enclii logs janua-api --env prod --since 1h -n 200     # last hour
...
# Rollback
enclii rollback janua-api --env prod                   # previous release
enclii rollback janua-api v42 --env prod

# Releases + deployment history
enclii releases janua-api -n 20
...
enclii domains list --service janua-api
enclii domains add my.example.com --service janua-api   # auto-provisions tunnel route + DNS
