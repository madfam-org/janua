...
describe('SignIn Component', () => {
  ...
  it('should show sign up link when signUpUrl is provided', () => {
    renderSignIn({ signUpUrl: '/auth/sign-up' });

    expect(screen.getByText(/don't have an account/i)).toBeInTheDocument();
    expect(screen.getByRole('link', { name: /sign up/i })).toBeInTheDocument();
  });

  it('should not show sign up link when signUpUrl is not provided', () => {
    renderSignIn();
  ...
  it('should handle successful sign in', async () => {
    ...
    renderSignIn({ onSuccess, redirectTo: '/dashboard' });
    ...
    await waitFor(() => {
      // onSuccess is called via afterSignIn wrapper which passes no args
