"""
Enterprise License Management for Plinto Python SDK
    ...
    async def require_enterprise(self, feature: str) -> None:
        ...
        if license_info.plan == Plan.COMMUNITY:
            raise EnterpriseError(
                ...
                f"Visit https://plinto.dev/pricing or contact sales@plinto.dev",
                'ENTERPRISE_REQUIRED',
                {'feature': feature, 'upgrade_url': 'https://plinto.dev/pricing'}
            )
        ...
        if feature not in license_info.features:
            raise EnterpriseError(
                ...
                'FEATURE_NOT_AVAILABLE',
                {
                    ...
                    'upgrade_url': 'https://plinto.dev/pricing'
                }
            )
