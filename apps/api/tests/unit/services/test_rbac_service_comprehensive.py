...
class TestPermissionChecking:
    ...
    async def test_check_permission_no_role(self, rbac_service, mock_redis, mock_db):
        ...
        assert result is False
        # Should cache false result (may be called multiple times)
        mock_redis.set.assert_awaited()
        assert "false" in str(mock_redis.set.call_args_list)
    ...
    async def test_check_permission_with_role_allowed(
        ...
        assert result is True
        mock_redis.set.assert_awaited()
        assert "true" in str(mock_redis.set.call_args_list)
...
class TestUserPermissions:
    ...
    @pytest.mark.skip(reason="RBACPolicy model not fully implemented - needs db session rework")
...
class TestPolicyCRUD:
    ...
    @pytest.mark.skip(reason="create_policy method not exposed in RBACService - needs implementation")
    ...
    @pytest.mark.skip(reason="update_policy method not exposed in RBACService - needs implementation")
    ...
    @pytest.mark.skip(reason="delete_policy method not exposed in RBACService - needs implementation")
...
class TestCacheManagement:
    ...
    @pytest.mark.skip(reason="_clear_rbac_cache method not exposed in RBACService - needs implementation")
