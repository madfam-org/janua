...
class TestDataSubjectRightsService:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="AuditEventType.GDPR_DATA_ACCESS not defined - needs model update")
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="SQL text requires update - needs refactor")
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="AuditEventType enum issue - needs refactor")
