...
class TestMFARouter:
    ...
    def test_get_mfa_status(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            "app.services.auth_service.AuthService", MagicMock()
        ) as mock_mfa:
    ...
    def test_verify_totp_setup(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.post(
                "/api/v1/mfa/totp/verify", json=verify_data, headers=self.auth_headers
            )
            assert 200 <= response.status_code < 600
    ...
    def test_disable_totp_mfa(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.delete(
                "/api/v1/mfa/totp", json=disable_data, headers=self.auth_headers
            )
            assert 200 <= response.status_code < 600
    ...
    def test_setup_sms_mfa(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            mock_user.return_value = {"id": "user_123"}
            mock_sms.return_value = {"phone_number": "+1234567890", "verification_sent": True}

            response = self.client.post(
                "/api/v1/mfa/sms/setup", json=sms_data, headers=self.auth_headers
            )
            assert 200 <= response.status_code < 600
    ...
    def test_verify_sms_setup(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.post(
                "/api/v1/mfa/sms/verify", json=verify_data, headers=self.auth_headers
            )
            assert 200 <= response.status_code < 600
    ...
    def test_verify_mfa_challenge(self):
        ...
        challenge_data = {"mfa_token": "temp_mfa_token_123", "code": "123456", "method": "totp"}
    ...
    def test_disable_mfa_method(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.delete(
                f"/api/v1/mfa/{method}", json=disable_data, headers=self.auth_headers
            )
            assert 200 <= response.status_code < 600
...
class TestPasskeyRouter:
    ...
    def test_begin_passkey_registration(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.post(
                "/api/v1/passkeys/register/begin", headers=self.auth_headers
            )
            assert 200 <= response.status_code < 600
    ...
    def test_rename_passkey(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.patch(
                f"/api/v1/passkeys/{passkey_id}", json=rename_data, headers=self.auth_headers
            )
            assert 200 <= response.status_code < 600
    ...
    def test_delete_passkey(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.delete(
                f"/api/v1/passkeys/{passkey_id}", headers=self.auth_headers
            )
            assert 200 <= response.status_code < 600
    ...
    def test_get_passkey_details(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.get(f"/api/v1/passkeys/{passkey_id}", headers=self.auth_headers)
            assert 200 <= response.status_code < 600
...
class TestOAuthRouter:
    ...
    def test_oauth_google_authorize(self):
        ...
        params = {"redirect_uri": "https://myapp.com/callback", "state": "random_state_123"}
    ...
    def test_oauth_google_callback(self):
        ...
        params = {"code": "oauth_authorization_code", "state": "random_state_123"}
    ...
    def test_oauth_github_authorize(self):
        ...
        params = {"redirect_uri": "https://myapp.com/callback", "state": "random_state_456"}
    ...
    def test_oauth_github_callback(self):
        ...
        params = {"code": "github_oauth_code", "state": "random_state_456"}
    ...
    def test_unlink_oauth_provider(self):
        ...
        with patch("app.dependencies.get_current_user") as mock_user, patch(
            ...
            response = self.client.delete(f"/api/v1/oauth/{provider}", headers=auth_headers)
            assert 200 <= response.status_code < 600
