...
class TestUserRouter:
    ...
    def test_update_current_user(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.update_user') as mock_update:
    ...
    def test_delete_current_user(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.delete_user') as mock_delete:
    ...
    def test_get_user_sessions(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.get_user_sessions') as mock_sessions:
    ...
    def test_revoke_user_session(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.revoke_session') as mock_revoke:

            mock_user.return_value = {"id": "user_123"}
            mock_revoke.return_value = {"revoked": True}

            response = self.client.delete(f"/api/v1/users/me/sessions/{session_id}",
                                        headers=self.auth_headers)
            assert response.status_code in [200, 204, 401, 404]
...
class TestOrganizationRouter:
    ...
    def test_create_organization(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.create_organization') as mock_create:
    ...
    def test_get_user_organizations(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.get_user_organizations') as mock_orgs:
    ...
    def test_get_organization_details(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.get_organization') as mock_org:
    ...
    def test_update_organization(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.update_organization') as mock_update:

            mock_user.return_value = {"id": "user_123"}
            mock_update.return_value = {"updated": True}

            response = self.client.patch(f"/api/v1/organizations/{org_id}",
                                       json=update_data,
                                       headers=self.auth_headers)
    ...
    def test_delete_organization(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.delete_organization') as mock_delete:
...
class TestSessionRouter:
    ...
    def test_get_active_sessions(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.get_active_sessions') as mock_sessions:
    ...
    def test_revoke_all_sessions(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.revoke_all_sessions') as mock_revoke:
    ...
    def test_extend_session(self):
        ...
        with patch('app.dependencies.get_current_user') as mock_user, \
             patch('app.services.auth_service.AuthService.extend_session') as mock_extend:
