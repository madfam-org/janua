...
class TestComplianceFrameworkMonitoring:
    ...
    async def test_compliance_monitor_initialization(self, mock_db_session):
        ...
        try:
            ...
            compliance_monitor = (
                ComplianceMonitor(mock_db_session)
                if hasattr(ComplianceMonitor, "__init__")
                else ComplianceMonitor()
            )
    ...
    async def test_sox_compliance_monitoring(self, mock_db_session):
        ...
        try:
            ...
            sox_methods = [
                (
                    "assess_framework_compliance",
                    {"framework": "SOX", "controls": sox_controls, "scope": "organization"},
                ),
                (
                    "evaluate_control_effectiveness",
                    {
                ...
                (
                    ...
                    {"framework": "SOX", "findings": [{"control": "AC-1", "status": "open"}]},
                ),
                (
                    "calculate_compliance_score",
                    {"framework": "SOX", "weighting": {"critical": 3, "high": 2, "medium": 1}},
                ),
            ]
    ...
    async def test_gdpr_compliance_monitoring(self, mock_db_session):
        ...
        try:
            ...
            gdpr_methods = [
                (
                    "assess_framework_compliance",
                    {"framework": "GDPR", "controls": gdpr_controls, "scope": "data_processing"},
                ),
                (
    ...
    async def test_hipaa_compliance_monitoring(self, mock_db_session):
        ...
        try:
            ...
            hipaa_methods = [
                (
                    "assess_framework_compliance",
                    {"framework": "HIPAA", "controls": hipaa_controls, "scope": "phi_handling"},
                ),
                (
                    "monitor_phi_access",
                    {
        ...
        try:
            ...
            storage_methods = [
                ...
                (
                    ...
                    {"controls": ["AC-1", "AC-2"], "format": "zip", "include_metadata": True},
                ),
                (
                    "archive_evidence",
                    {
