        ...
        if event in self._events:
            for handler in self._events[event]:
                try:
                    ...
                    logger.error(f"Error in event handler for {event}", error=str(e))
        ...
        if event in self._async_events:
            ...
            for handler in self._async_events[event]:
                try:
                    ...
                    logger.error(f"Error in async event handler for {event}", error=str(e))
            if tasks:
