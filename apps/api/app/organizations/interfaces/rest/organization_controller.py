...
class OrganizationController:
    ...
    async def create_organization(
        self, request: CreateOrganizationRequest, current_user: User = Depends(get_current_user)
    ) -> OrganizationResponse:
    ...
    async def get_organization(
        self, org_id: str, current_user: User = Depends(get_current_user)
    ) -> OrganizationResponse:
        ...
        try:
            ...
            # Create query
            query = GetOrganizationQuery(organization_id=org_uuid, user_id=current_user.id)
    ...
    async def list_members(
        ...
        try:
            ...
            # Create query
            query = ListMembershipsQuery(organization_id=org_uuid, requester_id=current_user.id)
