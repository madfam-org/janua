...
class SAMLProtocol(SSOProtocol):
    ...
    def get_required_config_fields(self) -> list[str]:
        return ["entity_id", "sso_url", "certificate", "acs_url"]
        ...
        **kwargs,
        ...
        if self.cache_service:
            await self.cache_service.set(
                f"saml_request:{request_id}", request_state, ttl=600  # 10 minutes
            )
        ...
        return {
            ...
            "params": {"SAMLRequest": saml_request, "RelayState": request_id},
        }
    ...
    async def handle_callback(self, callback_data: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        ...
        user_data = self.attribute_mapper.map_saml_attributes(
            attributes, config.get("attribute_mapping", {})
        )
    ...
    async def initiate_logout(
        self, session_data: Dict[str, Any], config: Dict[str, Any], return_url: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "params": {"SAMLRequest": slo_request},
        }
