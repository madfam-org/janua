...
class NotificationChannel:
    ...
    def __post_init__(self):
        ...
        if missing_keys:
            raise ValueError(f"Missing required config keys for {self.channel_type}: {missing_keys}")
...
class NotificationRequest:
    ...
    def is_urgent(self) -> bool:
        ...
        return (self.priority == NotificationPriority.URGENT or 
                self.alert.severity.name == "CRITICAL")
