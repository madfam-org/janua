    ...
    def fix_test_client_usage(self, content: str) -> str:
        ...
        if "TestClient" in content and "async def test_" in content:
            ...
            content = content.replace(
                "from fastapi.testclient import TestClient", "from httpx import AsyncClient"
            )
            content = content.replace(
                "TestClient(app", 'AsyncClient(app=app, base_url="http://test"'
            )
