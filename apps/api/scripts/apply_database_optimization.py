...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("database_optimization.log"), logging.StreamHandler(sys.stdout)],
)
...
"""
        ...
        if (
            performance_analysis["has_pg_stat_statements"]
            and "slow_queries" in performance_analysis
        ):
...
async def main():
    ...
    try:
        ...
        logger.info(
            f"📊 Final Results: {successful_indexes}/{total_indexes} indexes successfully applied"
        )
